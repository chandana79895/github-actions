	...
	//Initializing the Page Objects:
		...
		public void verifySuccessfullLogin(WebDriver driver, String expectedUrl) {
			try {
		        ...
		        boolean isUrlChanged = wait.until(ExpectedConditions.urlToBe("https://d2plgzr052bm70.cloudfront.net/member-search"));

		        if (isUrlChanged) {
		            String currentUrl = driver.getCurrentUrl();
		            System.out.println("After successful login, navigated to the Location screen: " + currentUrl);
		            String expectedUrl1 = "https://d2plgzr052bm70.cloudfront.net/member-search";
